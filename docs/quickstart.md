...
The tabs are the same records seen six ways. **Table** is every record, filterable and searchable,
and is where most people live. **Graph** is the dependency diagram. **Timeline** is the Gantt.
**Cycles** is one page per cycle, with what was bet in it and who has room. **People** is who is on
what. **Issues** is the pile of things somebody noticed. Clicking any record opens its own page,
which is where you edit it.
