...
class Index(BaseModel):
    ...
    # Carried so a predicate can ask where build ends without rebuilding a
    # Config: doing that substitutes the default cool-down for the repository's
    # own, and a filter that quietly disagrees with the timeline it explains is
    ...
    def build_end(self, cycle: int | None) -> date | None:
        """The last day of a cycle's build, from its record or its cool-down."""
